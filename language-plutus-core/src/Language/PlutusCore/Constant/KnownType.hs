...
module Language.PlutusCore.Constant.KnownType
    ( ReflectT (..)
    , KnownType (..)
    , PrettyKnown (..)
    , KnownTypeValue (..)
...
shiftTypeScheme (TypeSchemeResult res)      = TypeSchemeResult res
shiftTypeScheme (TypeSchemeArrow  arg schB) = TypeSchemeArrow arg $ shiftTypeScheme schB
shiftTypeScheme (TypeSchemeAll    var schK) =
    TypeSchemeAllType var $ \_ -> shiftTypeScheme $ schK Proxy

unshiftTypeScheme
    :: forall b uni a r. (Evaluable uni, Typeable b)
    => TypeScheme (Extend b uni) a r -> TypeScheme uni a r
unshiftTypeScheme (TypeSchemeResult res)      = TypeSchemeResult res
unshiftTypeScheme (TypeSchemeArrow  arg schB) = TypeSchemeArrow arg $ unshiftTypeScheme schB
unshiftTypeScheme (TypeSchemeAll    var schK) =
